...
__C.TRAIN.SCR.X_WIDTH_PER_GROUP = 4 
...
__C.TRAIN.CENTER_CROP = False 
__C.TRAIN.COLOR_JITTER = False
__C.TRAIN.CJ_BRIGHTNESS = 0.1
__C.TRAIN.CJ_CONTRAST = 0.1
__C.TRAIN.CJ_SATURATION = 0.1
__C.TRAIN.CJ_HUE = 0.1
__C.TRAIN.PIXEL_JITTER = False
__C.TRAIN.PJ_MAX = 0 
__C.TRAIN.RANDOM_AFFINE = False
__C.TRAIN.RA_DEGREES = 10  # (-10, 10)
__C.TRAIN.RA_TRANSLATE = (0.1, 0.1)    # horizontal, vertical
__C.TRAIN.RA_SCALE = (1, 1)   
__C.TRAIN.RA_SHEAR = 10    # (-10, 10) 
__C.TRAIN.RA_RESAMPLE = False  # PIL.Image.NEAREST by default
__C.TRAIN.RA_FILLCOLOR = 0
__C.TRAIN.RANDOM_CROP = True 
__C.TRAIN.RANDOM_HFLIP = True 
__C.TRAIN.RANDOM_VFLIP = False 
__C.TRAIN.RANDOM_RESIZED_CROP = False
__C.TRAIN.RRC_SCALE = (0.08, 1.0)
__C.TRAIN.RRC_RATIO = (3.0/4, 4.0/3)
__C.TRAIN.RRC_INTERPOLATION = 2
__C.TRAIN.RANDOM_ROTATION = False
__C.TRAIN.RR_DEGREES = 10  # (-10, 10)
__C.TRAIN.RR_RESAMPLE = False  # PIL.Image.NEAREST by default
__C.TRAIN.RR_EXPAND = False   # 
__C.TRAIN.RR_CENTER = None    # rotate center by default
__C.TRAIN.RESIZE = 0 
__C.TRAIN.FORCE_RESIZE = True
__C.TRAIN.R_INTERPOLATION = 2
