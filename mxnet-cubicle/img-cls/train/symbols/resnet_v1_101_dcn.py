...
def get_resnet_v1_conv5(num_classes, dcn_switch=[0 for x in xrange(5)]):
    ...
    # classifier
    pool1 = mx.symbol.Pooling(data=res5c_relu, global_pool=True, kernel=(7, 7), pool_type='avg', name='pool1')
...
def get_symbol(num_classes, num_layers, image_shape, conv_workspace=256, **kwargs):
    units = [3, 4, 23, 3]    # num_layers=101
    num_stages = 4
    filter_list = [64, 64, 128, 256, 512]
    return get_resnet_v1_conv5(num_classes) 


if __name__ == '__main__':
    sym = get_symbol(1000, 101, (224, 224))
    sym.save('dummy-symbol.json')
    print('Symbol: R101-v1 successfully generated as dummy-symbol.json')
